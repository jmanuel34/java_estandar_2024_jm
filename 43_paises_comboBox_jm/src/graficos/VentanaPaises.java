...
public class VentanaPaises extends JFrame {
	...
	public VentanaPaises() {
		...
		JComboBox<String> comboContinentes = new JComboBox<String>();
		comboContinentes.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				JOptionPane.showMessageDialog(VentanaPaises.this, "Paises de "+continente+": " +service.getPaisesFiltradosPor(continente));
			}
		});
		comboContinentes.setBounds(152, 27, 119, 164);
