...
public class Cajero {
	...
	public static void main(String[] args) {
		CajeroService cajero = CajeroServiceFactory.getCajeroService();
		...
		System.out.println();
		System.out.println("Lista de movimientos de la cuenta 1000");
		...
		for (Cliente c:clientes) {
			System.out.println();
			System.out.println("Titulares de la cuenta 1000");
